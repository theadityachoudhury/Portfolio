export const data: {
    ...
    hostedLink: string
        ...
        },
        {
            ...
            githubLink: "https://github.com/theadityachoudhury/Event-Manager-Backend",
            hostedLink: "https://evently.adityachoudhury.com"
        },
        {
            projectName: "URL Shortener",
            projectType: "full-stack",
            techStack: "NextJS, MongoDB, Vercel",
            year: 2024,
            description: "Shorten your URL with ease and share it with your friends. It's that simple.",
            githubLink: "https://github.com/theadityachoudhury/url-shortner",
            projectImage: "https://raw.githubusercontent.com/theadityachoudhury/url-shortner/main/shortly.png",
            hostedLink: "https://shortly.adityachoudhury.com"
        },
        {
            projectName: "Auth Starter Pack using TS",
            projectType: "Backend",
        ...
        {
            projectName: "PiceWise - Price Tracker",
            projectType: "full-stack",
