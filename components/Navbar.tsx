    ...
    return (
        <div className="p-5 relative"> {/* Added relative positioning */}
            <div className="flex sm:justify-around">
                <h1 className="text-3xl font-bold text-center">adityachoudhury</h1>
                <div className="hidden sm:flex space-x-5 justify-between text-xl text-slate-200">
                    <a href="/" className="hover:text-blue-600">Home</a>
                    <a href="https://github.com/theadityachoudhury" target="_blank" className="hover:text-blue-600">Github</a>
                    <a href="/resume/Aditya_Narayana_Choudhury.pdf" target="_blank" className="hover:text-blue-600">Resume</a>
                </div>
            ...
            {showMenu && <div className="sm:hidden fixed top-16 left-56 bg-slate-800 backdrop-blur-sm flex flex-col rounded-md p-3 max-w-32 mt-2 text-xl space-y-3"> {/* Added absolute positioning */}
                <a href="#" className="hover:text-blue-600">Home</a>
                <a href="https://github.com/theadityachoudhury" target="_blank" className="hover:text-blue-600">Github</a>
                <a href="/resume/Aditya_Narayana_Choudhury.pdf" target="_blank" className="hover:text-blue-600">Experience</a>
            </div>}
        </div >
    )
}
